...
class DataProcessor(ABC):
    ...
    def run(self) -> None:
        ...
        colums_for_del = ['External Video ID', 'Thumbnail link', 'Video Likes Removed', 'User Subscriptions Removed', 'Average View Percentage', ]
        cleaned_dataframe = self.remove_col_by_name(self._dataset, colums_for_del)
        self.result = cleaned_dataframe
        self.print_result()
